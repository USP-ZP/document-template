...
\begin{titlepage}
	...
	\begin{flushleft}
		...
		\ifdefstring{\tipodocumento}{recomendacao}{ \input{template/recomendacao/subcapa}}{
			\ifdefstring{\tipodocumento}{procedimento}{ \input{template/procedimento/subcapa} }{
				\ifdefstring{\tipodocumento}{instrucaotrabalho}{ \input{template/instrucaotrabalho/subcapa} }{
					\ifdefstring{\tipodocumento}{checklist}{ \input{template/checklist/subcapa} }{
						\input{template/documento/subcapa}
					}
				}
			}
		}
