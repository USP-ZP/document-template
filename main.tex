%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   LaTeX source code de documentos de recomendações
%   Produzido para a USP Zé Povinho - ACES Oeste Norte
%
% 	Desenvolvido por: Estêvão Soares dos Santos
...
% Load the titlesec package for formatting section and subsection titles
\usepackage{titlesec}
...
\usepackage{lipsum}
\usepackage[shiftHeadings=1, startNumber=false, pipeTables=true]{markdown}
\usepackage{fancyhdr}
...
\def\numero{D\id.\ano}
\def\versao{\major.\minor.\patch}

%%% Utils
\input{template/utils/checkdir.tex}
\input{template/utils/includeallfromdir.tex}
...
\begin{document}
	...
	\ifdefstring{\tipodocumento}{recomendacao}{
		% recomendação
		\input{template/recomendacao/base.tex}
		
	}{
		\ifdefstring{\tipodocumento}{procedimento}{
			% procedimento
			\input{template/procedimento/base.tex}

		}{
			\ifdefstring{\tipodocumento}{instrucaotrabalho}{
				% instrução de trabalho
				\input{template/instrucaotrabalho/base.tex}

			}{
				% default (Documento)
				\input{template/documento/base.tex}
			}
		}
	}
	...
	\checkdir{conteudo/anexos}
	\ifnum\dirresult=1
	\section{Anexos}
	\includeallfromdir{conteudo/anexos}
	\fi
